...
The definition of an ETL Task will be a python class inheriting from :class:`bi_etl.scheduler.etl_task.ETLTask`.
...
To start the task, call the ``run`` method of ``ETLTask``. This a standard framework method. It will:
   ...
   b.	Call the :meth:`init <bi_etl.scheduler.etl_task.ETLTask.init>` method that you *can* override in your class.
   c.	Call the :meth:`load <bi_etl.scheduler.etl_task.ETLTask.load>` method that you **must** override in your class.
   d.	Call the :meth:`finish <bi_etl.scheduler.etl_task.ETLTask.finish>` method that you *can* override in your class.
