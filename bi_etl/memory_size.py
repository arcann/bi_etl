...
def get_size_gc(obj, depth_limit=10, depth=0, processed_objects=None, processed_classes=None, ref_chain= None):
    """
    ...
    for chld in gc.get_referents(obj):
        size += get_size_gc(chld, depth_limit=depth_limit, depth= depth+1, processed_objects=processed_objects, processed_classes=processed_classes, ref_chain=ref_chain)
