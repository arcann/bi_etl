...
from typing import Set, Optional, Iterable, MutableSequence
...
class HistoryTable(Table):
    ...
    def __init__(
            ...
            exclude_columns: Optional[Set[Union[str, Column]]] | None = None,
            default_effective_date: datetime | None = None,
            **kwargs
    ):
    ...
    def apply_updates(
            self,
            row,
            changes_list: MutableSequence[ColumnDifference] | None = None,
            additional_update_values: Union[dict, Row] | None = None,
    ...
    def _target_excludes_for_updates(self, target_excludes: frozenset | None):
        if target_excludes is None:
            target_excludes = set()
    ...
    def upsert(
            ...
            skip_update_check_on: frozenset | None = None,
            do_not_update: list | None = None,
            additional_update_values: dict | None = None,
            additional_insert_values: dict | None = None,
            update_callback: Callable[[MutableSequence, Row], None] | None = None,
            insert_callback: Callable[[Row], None] | None = None,
            source_excludes: frozenset | None = None,
            target_excludes: frozenset | None = None,
    ...
    def physically_delete_version(
        ...
        **Physically** delete a given version row. Corrects the preceding end date value.
        ...
        if prior_row is not None and prior_row is not ...:
            assert isinstance(prior_row, Row)
    ...
    def cleanup_versions(
            ...
            remove_redundant_versions: bool | None = None,  # Default depends on auto_generate_key value
            lookup_name: str | None = None,
            exclude_from_compare: frozenset | None = None,
            criteria_list: list | None = None,
            criteria_dict: dict | None = None,
            use_cache_as_source: bool = True,
    ...
    def _sql_find_updates(
            ...
            key_columns_set: Iterable,
            non_nk_matching_columns: Iterable,
    ...
    def _sql_insert_deletes(
            self,
            target_column_set: Iterable,
            metadata_column_set: Iterable,
            deleted_row_nk_table: str,
            connection_name: str = 'sql_upsert',
    ):
    ...
    def sql_upsert(
            ...
            check_for_deletes: bool | None = None,
            connection_name: str = 'sql_upsert',
